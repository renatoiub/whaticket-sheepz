  ...
  pt: {
    translations: {
      signup: {
        title: "Cadastre-se",
        toasts: {
          success: "Conta criado com sucesso! Faça seu login!!!.",
      ...
      whatsappModal: {
        ...
        form: {
          ...
          queueRedirectionDesc: "Selecione uma setor para os contatos que não possuem setores, serem redirecionados",
          prompt: "Prompt",
          maxUseBotQueues: "Quantas vezes enviar o bot?",
          timeUseBotQueues: "Intervalo em minutos entre envio de bot",
          expiresTicket: "Quanto tempo em minutos para encerrar automaticamente a conversa?",
