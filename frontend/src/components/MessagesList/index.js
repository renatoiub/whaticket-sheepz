...
const MessagesList = ({ ticket, ticketId, isGroup }) => {
  ...
  const checkMessageMedia = (message) => {
    ...
    else if (message.mediaType === "multi_vcard" || message.mediaType === "contactsArrayMessage") {

      if (message.body !== null && message.body !== "") {
        let newBody = []
        try { newBody = JSON.parse(message.body) } catch (error) { newBody = [] }
            ...
            <React.Fragment key={message.id}>
              ...
              <div className={classes.messageLeft}>
                ...
                {(message.mediaUrl || message.mediaType === "locationMessage" || message.mediaType === "contactMessage" || message.mediaType === "contactsArrayMessage"
                  || message.mediaType === "multi_vcard" || message.mediaType === "vcard"
                ...
                <div className={classes.textContentItem}>
                  ...
                  {message.mediaType === "contactMessage" || message.mediaType === "contactsArrayMessage" ? null : <MarkdownWrapper>{message.mediaType === "locationMessage" ? null : message.body}</MarkdownWrapper>}
